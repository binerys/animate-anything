...
function GL_Context( canvas_id )
	{																// Special WebGL-only Initialization
		...
		{	
			...
			this.lightPosition_loc 	= gl.getUniformLocation(program, "lightPosition");		this.attenuation_factor_loc = gl.getUniformLocation(program, "attenuation_factor"); 
			...
			this.COLOR_NORMALS_loc 	= gl.getUniformLocation(program, "COLOR_NORMALS");
